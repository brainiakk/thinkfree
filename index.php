...
<html>
<head>
	<title>Think Free Concepts</title>
	<!-- META TAGS -->
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="shortcut icon" type="image/x-icon" href="assets/img/my_tfc_logo_main-001.png">
...
<body class="animsition">
	...
	<header class="main-header">
		<div class="container">
			<div class="logo">
				<a href="index.html" style="font-weight: bold;"><img style="width: 50px; height: 50px;" src="assets/img/my_tfc_logo_main-001.png" alt="logo"> THINK FREE CONCEPTS</a>
			</div>
				...
				<div class="row">
					<nav class="footer-nav">
						<ul>
							...
							<li><a href="about.php" class="animsition-link link">about us</a></li>
							<li><a href="services.php" class="animsition-link link">services</a></li>
							<li><a href="portfolio-1.php" class="animsition-link link">portfolio</a></li>
							<li><a href="blog-1.html" class="animsition-link link">blog</a></li>
							<li><a href="contact.php" class="animsition-link link">contact us</a></li>
						</ul>
					</nav>
				</div>
			</div>
			...
			<div class="col-md-4 col-sm-12" style="text-align:right">
				<div class="row">
					<div class="uppercase gray-text">
						Think Free Concepts &copy;<?php echo date("Y"); ?>. all rights reserved.
					</div>
